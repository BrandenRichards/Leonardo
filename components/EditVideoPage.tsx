...
// FIX: The `Video` type does not exist, using `GeneratedVideo` and updating props.
import {GeneratedVideo} from '../types';

interface EditVideoPageProps {
  video: GeneratedVideo;
  onSave: (updatedVideo: GeneratedVideo) => void;
  onCancel: () => void;
}
...
export const EditVideoPage: React.FC<EditVideoPageProps> = ({
  ...
  // FIX: The `description` property does not exist on `GeneratedVideo`, using `prompt` instead.
        ...
        <main>
          <div className="mb-6">
            ...
            <textarea
              ...
              aria-label={`Edit prompt for the video`}
            />
          </div>
        </main>
